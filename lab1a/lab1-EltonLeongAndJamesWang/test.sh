...
time ./simpsh --rdonly testfiles/foo --creat --wronly err --pipe --pipe --pipe --pipe --pipe --pipe --command 0 3 1 cat /dev/urandom --command 2 5 1 tr -dc 'a-zA-Z0-9' --command 4 7 1 head -c 100M --command 6 1 1 grep 'James' --command 0 9 1 cat /dev/urandom --command 8 11 1 tr -dc 'a-zA-Z0-9' --command 10 13 1 head -c 10M --command 12 1 1 grep 'James' --wait 6
